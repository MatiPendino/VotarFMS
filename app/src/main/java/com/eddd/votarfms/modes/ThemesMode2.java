...
public class ThemesMode2 extends Activity {
    ...
    public static float totalFirstMcThemes2, totalSecondMcThemes2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.themes_mode2);
        ...
        tv_secondMc = findViewById(R.id.text_secondMcThemes);
        tv_firstMc = findViewById(R.id.text_firstMcThemes);
    ...
    private void nextRound(){
        ...
        btn_nextRound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    totalFirstMcThemes2 = pointsFm1 + pointsFm2 + pointsFm3 + pointsFm4 + pointsFmScene + pointsFmFlow + pointsFmSkills;
                    totalSecondMcThemes2 = pointsSm1 + pointsSm2 + pointsSm3 + pointsSm4 + pointsSmScene + pointsSmFlow + pointsSmSkills;

                    if(leagueSelected.equals("Inter Final")){
                        Intent intent = new Intent(getApplicationContext(), ObjetosFinalMode.class);
                        startActivity(intent);
                    } else{
                        Intent intent = new Intent(getApplicationContext(), RandomMode.class);
                        startActivity(intent);
                    }
            }
        });
