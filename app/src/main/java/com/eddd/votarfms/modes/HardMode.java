...
public class HardMode extends Activity {
    ...
    public static float totalFirstMcHard, totalSecondMcHard;
    ...
    private void nextRound(){
        ...
        btn_nextRound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    totalFirstMcHard = pointsFm1 + pointsFm2 + pointsFm3 + pointsFm4
                            + pointsFm5 + pointsFm6 + pointsFmScene + pointsFmFlow + pointsFmSkills;
                    totalSecondMcHard = pointsSm1 + pointsSm2 + pointsSm3 + pointsSm4
                            + pointsSm5 + pointsSm6 + pointsSmScene + pointsSmFlow + pointsSmSkills;

                    Intent intent = new Intent(getApplicationContext(), ThemesMode.class);
