...
import com.eddd.votarfms.modes.Deluxe;
...
public class ObjetosFinalMode extends AppCompatActivity {

    private Button fm1, fm2, fm3, fm4, fm5, fm6, fm7, fm8, fm9, fm10, fm11, sm9, sm10, sm11,
    ...
    private float pointsFm9, pointsFm10, pointsFm11, pointsSm9, pointsSm10, pointsSm11;

    public static float totalFirstMcObjects, totalSecondMcObjects;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_objetos_final_mode);
        ...
        fm10 = findViewById(R.id.et_fm10);
        fm11 = findViewById(R.id.et_fm11);
        ...
        sm10 = findViewById(R.id.et_sm10);
        sm11 = findViewById(R.id.et_sm11);
    ...
    private void sumPoints(){
        ...
        fm10.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fm10.setText(String.valueOf(pointsFm10));
            }
        });
        ...
        fm11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fm11.setText(String.valueOf(pointsFm11));
            }
        });
        ...
        sm10.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sm10.setText(String.valueOf(pointsSm10));
            }
        });
        ...
        sm11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sm11.setText(String.valueOf(pointsSm11));
            }
        });
    ...
    private void resetPoints(){
        ...
        fm10.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
        ...
        fm11.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
        ...
        sm10.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
        ...
        sm11.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
    ...
    private void nextRound(){
        ...
        btn_nextRound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //ahora guardo el puntaje total de cada ronda de ambos mcs
                totalFirstMcObjects = pointsFm1 + pointsFm2 + pointsFm3 + pointsFm4
                        + pointsFm5 + pointsFm6 + pointsFm7 + pointsFm8 + pointsFm9 + pointsFm10 + pointsFm11 + pointsFmScene + pointsFmFlow + pointsFmSkills;
                totalSecondMcObjects= pointsSm1 + pointsSm2 + pointsSm3 + pointsSm4
                        + pointsSm5 + pointsSm6 + pointsSm7 + pointsSm8 + pointsFm9 + pointsFm10+ pointsFm11 + pointsSmScene + pointsSmFlow + pointsSmSkills;
