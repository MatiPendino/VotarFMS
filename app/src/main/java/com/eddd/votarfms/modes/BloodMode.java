...
public class BloodMode extends Activity {
    ...
    private CheckBox cb_fm1, cb_fm2, cb_fm3, cb_fm4, cb_fm5, cb_fm6;
    ...
    public static float totalFirstMcBlood, totalSecondMcBlood;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.blood_mode);
        ...
        tv_secondMc = findViewById(R.id.supertexto_secondMcBlood);
        tv_firstMc = findViewById(R.id.supertexto_firstMcBlood);
        cb_fm1 = findViewById(R.id.cb_fm1);
        cb_fm2 = findViewById(R.id.cb_fm2);
        cb_fm3 = findViewById(R.id.cb_fm3);
        cb_fm4 = findViewById(R.id.cb_fm4);
        cb_fm5 = findViewById(R.id.cb_fm5);
        cb_fm6 = findViewById(R.id.cb_fm6);
    ...
    private void nextRound(){
        ...
        btn_nextRound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    totalFirstMcBlood = pointsFm1 + pointsFm2 + pointsFm3 + pointsFm4
                            + pointsFm5 + pointsFm6 + pointsFmScene + pointsFmFlow + pointsFmSkills;
                    totalSecondMcBlood = pointsSm1 + pointsSm2 + pointsSm3 + pointsSm4
                    ...
                    if (cb_fm6.isChecked()){
                        ...
                        Intent intent = new Intent(getApplicationContext(), BloodMode2.class);
