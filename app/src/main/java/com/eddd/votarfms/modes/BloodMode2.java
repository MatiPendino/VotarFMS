...
public class BloodMode2 extends Activity {
    ...
    private CheckBox cb_sm1, cb_sm2, cb_sm3, cb_sm4, cb_sm5, cb_sm6;
    ...
    public static float totalFirstMcBlood2, totalSecondMcBlood2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.blood_mode2);
        ...
        tv_firstMc = findViewById(R.id.supertextito_bladFirstMc);
        tv_secondMc = findViewById(R.id.supertextito_bladSecondMc);
        cb_sm1 = findViewById(R.id.cb_sm1);
        cb_sm2 = findViewById(R.id.cb_sm2);
        cb_sm3 = findViewById(R.id.cb_sm3);
        cb_sm4 = findViewById(R.id.cb_sm4);
        cb_sm5 = findViewById(R.id.cb_sm5);
        cb_sm6 = findViewById(R.id.cb_sm6);
    ...
    private void nextRound(){
        ...
        btn_nextRound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    totalFirstMcBlood2 = pointsFm1 + pointsFm2 + pointsFm3 + pointsFm4
                            + pointsFm5 + pointsFm6 + pointsFmScene + pointsFmFlow + pointsFmSkills;
                    totalSecondMcBlood2 = pointsSm1 + pointsSm2 + pointsSm3 + pointsSm4
