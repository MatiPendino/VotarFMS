...
public class Deluxe extends Activity {

    private Button fm1, fm2, fm3, fm4, fm5, fm6,fm7,fm8,fmrd1,fmrd2,fmrd3, sm1, sm2, sm3, sm4, sm5, sm6,sm7,sm8,smrd1,smrd2,smrd3, fmScene, fmFlow, fmSkills, smScene, smFlow, smSkills;
    private Button btn_nextRound;
    private TextView tv_firstMc, tv_secondMc;
    private String firstMc, secondMc;

    private float pointsFm1D, pointsFm2D, pointsFm3D, pointsFm1, pointsFm2, pointsFm3, pointsFm4, pointsFm5,
            pointsFm6, pointsFm7, pointsFm8, pointsFmScene, pointsFmFlow, pointsFmSkills;
    private float pointsSm1D, pointsSm2D, pointsSm3D, pointsSm1, pointsSm2, pointsSm3, pointsSm4, pointsSm5,
            pointsSm6, pointsSm7, pointsSm8, pointsSmScene, pointsSmFlow, pointsSmSkills;

    public static float totalFirstMcDeluxe, totalSecondMcDeluxe;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fm7 = findViewById(R.id.et_sm7);
        fm8 = findViewById(R.id.et_sm8);
        fmrd1 = findViewById(R.id.et_rdsm1);
        fmrd2 = findViewById(R.id.et_rdsm2);
        fmrd3 = findViewById(R.id.et_rdsm3);
        ...
        sm7 = findViewById(R.id.et_fm7);
        sm8 = findViewById(R.id.et_fm8);
        smrd1 = findViewById(R.id.et_rdfm1);
        smrd2 = findViewById(R.id.et_rdfm2);
        smrd3 = findViewById(R.id.et_rdfm3);
        ...
        tv_firstMc = findViewById(R.id.supersuper_firstMcDeluxe);
        tv_secondMc = findViewById(R.id.supersuper_secondMcDeluxe);
    ...
    private void sumPoints(){
        ...
        fmrd1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (pointsFm1D < 4){
                    pointsFm1D += 0.5;
                }
                fmrd1.setText(String.valueOf(pointsFm1D));
            }
        });

        fmrd2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (pointsFm2D < 4){
                    pointsFm2D += 0.5;
                }
                fmrd2.setText(String.valueOf(pointsFm2D));
            }
        });

        fmrd3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (pointsFm3D < 4){
                    pointsFm3D += 0.5;
                }
                fmrd3.setText(String.valueOf(pointsFm3D));
            }
        });
        ...
        smrd1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (pointsSm1D < 4){
                    pointsSm1D += 0.5;
                }
                smrd1.setText(String.valueOf(pointsSm1D));
            }
        });

        smrd2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (pointsSm2D < 4){
                    pointsSm2D += 0.5;
                }
                smrd2.setText(String.valueOf(pointsSm2D));
            }
        });

        smrd3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (pointsSm3D < 4){
                    pointsSm3D += 0.5;
                }
                smrd3.setText(String.valueOf(pointsSm3D));
            }
        });
    ...
    private void resetPoints(){
        ...
        fmrd1.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
        ...
        fmrd2.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
        ...
        fmrd3.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
        ...
        smrd1.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
        ...
        smrd2.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
        ...
        smrd3.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
    ...
    private void nextRound(){
        ...
        btn_nextRound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    totalFirstMcDeluxe = pointsFm1D + pointsFm2D + pointsFm3D + pointsFm1 + pointsFm2 + pointsFm3 + pointsFm4
                            + pointsFm5 + pointsFm6 + pointsFm7 + pointsFm8 + pointsFmScene + pointsFmFlow + pointsFmSkills;
                    totalSecondMcDeluxe = pointsSm1D + pointsSm2D + pointsSm3D + pointsSm1 + pointsSm2 + pointsSm3 + pointsSm4
